...
\COPY peliculas FROM 'C:/Users/melan/Desktop/peliculas.csv' csv header; no me funciono por permisos
\COPY reparto FROM 'C:/Users/melan/Desktop/reparto.csv' csv;
...
SELECT COUNT(nombre_actor) FROM reparto WHERE nombre_actor='Harrison Ford';
...
SELECT *
FROM peliculas WHERE anio_estreno BETWEEN 1990 AND 1999
...
SELECT LENGTH(pelicula)
-- y le asignaremos el nombre longitud_titulo
AS longitud_titulo
-- de la tabla peliculas
FROM peliculas;
...
SELECT pelicula, MAX(LENGTH(pelicula)) AS longitud_titulo_max FROM peliculas GROUP BY pelicula ORDER BY longitud_titulo_max DESC;